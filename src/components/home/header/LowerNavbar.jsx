...
export function LowerNavbar() {
  ...
  const menuServices = [
    { id: 1, title: "خدمة 1", to: "#" },
    { id: 2, title: "خدمة 2", to: "#" },
    { id: 3, title: "خدمة 3", to: "#" },
    { id: 4, title: "خدمة 4", to: "#" },
  ];

  const navItems = [
    { id: 1, title: "المقالات", to: "/#" },
    { id: 2, title: "المشاريع", to: "/#" },
    { id: 3, title: "الاسعار", to: "plans", isScrollLink: true },
    { id: 4, title: "تواصل معنا", to: "/#" },
  ];
  ...
  return (
    <>
      ...
      <div className={`w-full z-98 ${isScroll ? "fixed top-0 left-0" : ""}`}>
        <Navbar
          dir="ltr"
          className={`header-lower px-4 py-2 lg:px-4 lg:py-4 h-max lg:h-[5.5rem] max-w-full rounded-none border-0 bg-white ${isScroll
              ...
              <div className="flex items-center gap-x-6">
                ...
                <div>
                  <button
                    ...
                    aria-label="Search"
                    title="Search"
                    className="hidden lg:inline-block border-0 text-[1.375rem] font-normal text-dark-one cursor-pointer transition-all duration-300 ease-in-out"
                  >
                    <Search
                      strokeWidth={1.5}
                ...
                <div className="dropdown">
                  <div
                    tabIndex={0}
                    role="button"
                    className="btn bg-primary-one border-primary-one m-1"
                  >
                    {direction === "rtl" ? "AR" : "EN"}
                    <svg
                      width="12px"
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content bg-white rounded-box z-1 w-52 p-2 shadow-2xl"
                  >
                    <li>
                      <input
                        type="radio"
          ...
          >
            ...
            >
              ...
              <button
                type="button"
                aria-label="find"
                className="inline-block bg-primary-two p-3 rounded-md absolute ltr:right-62 rtl:left-62 rtl:top-1/2 rtl:-translate-y-1/2"
              >
